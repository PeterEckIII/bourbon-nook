    ...
    <nav className="sticky top-0 z-20 flex items-center justify-between bg-white shadow-2xl">
      ...
      <ul
        className={
          ...
          " transition-left fixed top-0 h-full w-10/12 space-y-5 bg-gray-50 py-2 text-white duration-300 lg:static lg:flex lg:w-auto lg:items-center lg:justify-center lg:space-x-7 lg:space-y-0 lg:bg-transparent lg:text-gray-500"
        }
      >
